...
ProtoMass建筑体量原型智能演绎工具是华建科技数字化所与华东院创作中心合作的数字化开发项目，旨在为原创设计师提供自动化交互式的初步体量方案生成服务。我在项目中担任技术负责人。从问题梳理，到技术路线的制订，再到实验执行，主要工作均有我负责计划和推进。当前该项目已完成立项开题，并在预实验阶段取得一定进展，包括：
  <ul>
    ...
    <li>基于Plugin-Scripting的开放接口与开发模式探索</li>
  </ul>
</div>
...
{% include figure_full.html link="https://workhub.oss-cn-shanghai.aliyuncs.com/picture/research/imghost-R25-B01-ProtoMass/img%20(2).jpg" note="用户操作流程规划" %}
...
{% include figure_full.html link="https://workhub.oss-cn-shanghai.aliyuncs.com/picture/research/imghost-R25-B01-ProtoMass/pre-experiment-01.png" note="组合要素预实验: 随手绘制场地边界，生成符合指标要求的重复体量组合" %}

<h5 class="chapter-heading-left">总结</h5>
项目弥合了计算算法与建筑体量原型方法之间的断层，将创新建筑设计重构为特定场地约束下建筑知识的编码与重用。它不仅拓展了建筑师的创作可能性，减轻了传统创新设计耗时费力的负担，同时也弥补了当前建筑数字化转译中的一项重要不足——现有技术多集中于创新需求较低的项目（如标准化住宅或办公楼层布局），而本项目则直面创新设计的高维挑战。当前项目仍在进行中，新的成果也将在此处更新，敬请期待... 
