...
ProtoMass建筑体量原型智能演绎工具是华建科技数字化所与华东院创作中心合作的数字化开发项目，旨在为原创设计师提供自动化交互式的初步体量方案生成服务。我在项目中担任技术负责人。从问题梳理，到技术路线的制订，再到实验执行，主要工作均由我负责计划和推进。当前该项目已完成总体架构设计和初步测试版本。项目亮点包括：
  <ul>
