...
<div class="plainpassage-brief">ProtoMass建筑体量原型智能演绎工具是华建科技数字化所与华东院创作中心合作的数字化开发项目，旨在为原创设计师提供自动化交互式的初步体量方案生成服务。我在项目中担任技术负责人。从问题梳理，到技术路线的制订，再到实验执行，主要工作均有我负责计划和推进。当前该项目已完成立项开题，并在预实验阶段取得一定进展，包括：
  <ul>
...
{% include figure_full.html link="http://workhub.oss-cn-shanghai.aliyuncs.com/picture/research/imghost-R25-B01-ProtoMass/pre-experiment-01.png" note="组合要素预实验: 随手绘制场地边界，生成符合指标要求的重复体量组合" %}
