...
武汉大学城市设计学院专业教学楼于2018年拆除。此后三年时间，学院教学活动主要在面积紧张的四方楼（原哲学院）开展。四方楼缺乏公共活动场所，唯一的大空间是C形围合出的庭院，学院拟对该空间加以改造。本设计基于经费拮据、临时使用的特殊背景，提出利用被拆除建筑的“循环用材”策略。设计利用的废弃材料包括被拆除建筑的绿色条状构件（截面尺寸40mm*100mm）、白色桁架构件（弦杆距500mm）、原室内装修的木制板片等。
